...
if [ $GIT_BRANCH_NAME = rc-v0.4.0-beta ]; then
	echo FHIR__CLIENT_ID=db6b2304-f236-45ec-b10c-a852681e7129 >> $DOTENV_FILE_OUT
	echo DB_CREDENTIALS__INTERNAL__PRIVATE_KEY=\'"${DB_CREDENTIALS__INTERNAL__DECRYPT_PRIVATE_KEY}"\' >> $DOTENV_FILE_OUT
else
