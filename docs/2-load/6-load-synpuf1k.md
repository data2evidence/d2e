...
- Docker container logs can be checked with the bash command

```bash
docker logs --tail 100 alp-dataflow-gen-worker
```
...
## Data flow logs
- open https://localhost:41100/portal/systemadmin/jobs/flow-runs
