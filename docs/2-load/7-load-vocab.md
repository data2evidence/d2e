...
- Run the following command in terminal to stop an alp docker container and start another container to load data
  ```bash
  yarn start:data-load --wait
  docker stop alp-dataflow-gen-agent-1
  docker exec -it alp-dataflow-gen-data-load-agent-1 prefect deployment run data-load-plugin/data-load-plugin_deployment --param options='{"files":[{"name": "CONCEPT_ANCESTOR","path": "/tmp/data/CONCEPT_ANCESTOR.csv", "truncate": "True"},{"name": "CONCEPT_CLASS","path": "/tmp/data/CONCEPT_CLASS.csv", "truncate": "True"},{"name": "CONCEPT_RELATIONSHIP","path": "/tmp/data/CONCEPT_RELATIONSHIP.csv", "truncate": "True"},{"name": "CONCEPT_SYNONYM","path": "/tmp/data/CONCEPT_SYNONYM.csv", "truncate": "True"},{"name": "CONCEPT","path": "/tmp/data/CONCEPT.csv", "truncate": "True"},{"name": "DOMAIN","path": "/tmp/data/DOMAIN.csv", "truncate": "True"},{"name": "DRU_STRENGTH","path": "/tmp/data/DRU_STRENGTH.csv", "truncate": "True"},{"name": "RELATIONSHIP","path": "/tmp/data/RELATIONSHIP.csv", "truncate": "True"},{"name": "VOCABULARY","path": "/tmp/data/VOCABULARY.csv", "truncate": "True"}],"schema_name":"cdmvocab","header":"true","delimiter":","}'
  ```
