...
export interface ConnectionInterface {
    ...
    executeStreamQuery(sql: string, parameters: ParameterInterface[], callback: CallBackInterface): void;
    ...
    executeProcWithSchema(proc: string, parameters: any[], schema: string, callback: CallBackInterface): void;
    commit(callback?: CallBackInterface): void;
