...
def cull_idle(
    ...
    req = HTTPRequest(
        url=url + '/users',
        headers=auth_header,
        # client_key="/srv/jupyterhub/internal-ssl/proxy-client/proxy-client.key",
        client_cert="/srv/jupyterhub/internal-ssl/proxy-client/proxy-client.crt",
        ca_certs="/srv/jupyterhub/tls-ca/hub-client-ca-trust.pem",
    )
