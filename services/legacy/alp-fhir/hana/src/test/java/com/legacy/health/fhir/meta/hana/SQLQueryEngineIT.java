...
public class SQLQueryEngineIT {
	...
	public static void setUpBeforeClass() throws Exception {
		...
		ClassLoader classLoader = SQLQueryEngineIT.class.getClassLoader();
		...
		File zipfile = new File(SQLQueryEngineIT.class.getClassLoader().getResource("spec.zip").getFile());
	...
	@Test
	public void testMarkus() throws Exception {
		// repo.
	}
	...
	public void testExpression() throws Exception {
		...
		engine.execute(query, new StructureConsumer() {
			public void writeStructure(Structure structure, Context context) throws SQLException {
				// System.out.println(((ValueElement)structure.getElementByPath("TestPatientQuery.gender")).getValue());
				// System.out.println(structure.getDefinition().getId());
			}
		}, context);
