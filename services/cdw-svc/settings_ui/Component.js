jQuery.sap.registerModulePath("sap.hc", "/hc");
...
sap.ui.define([
    ...
    "ui/core/IconPool",
    "ui/model/resource/ResourceModel"
], function (jQuery, UIComponent, JSONModel, IconPool, ResourceModel) {
    "use strict";

    var Component = UIComponent.extend("legacy.config.global.ui.Component", {
        metadata: {
            ...
            rootView: "legacy.config.global.ui.views.App"
        }
    });
    /**
    ...
    Component.prototype._fnAddHelpLink = function () {
        var oCorei18nResourceModel = new ResourceModel({
            bundleUrl: [jQuery.sap.getModulePath("legacy.core.ui"), "i18n/messagebundle.properties"].join("/")
        });
        if (sap.ushell && sap.ushell.renderers) {
            ...
            this._oHelpLink = new sap.m.Button({
                ...
                press: [function () {
                    var sUrl = "https://help.sap.com/viewer/fddd7c5de941469e9803c5a036d8d6ff/1.0.5/en-US/8d790097b7634380930a01776667f9da.html";
