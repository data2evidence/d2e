  ...
  patient: {
          ...
          priDiag: {
            ...
            attributes: {
              icd_10: {
                ...
                referenceFilter:
                  '@REF."ConceptVocabularyID" = \'ots.ICD.ICD10GM\' AND (LENGTH(@REF."ConceptCode")=3 OR (LENGTH(@REF."ConceptCode")=5 AND @REF."ConceptCode" LIKE \'%.-\'))',
                referenceExpression: 'LEFT(@REF."ConceptCode",3)',
                order: 1,
              },
              icd: {
                name: "ICD-10-CM Code",
    ...
    attributes: {
      ...
      smoker: {
        ...
        referenceFilter: "@REF.\"ConceptVocabularyID\"='mri.CAT.YES-NO'",
      ...
      gender: {
        ...
        referenceFilter: "@REF.\"ConceptVocabularyID\"='mri.CAT.GENDER'",
        referenceExpression: '@REF."ConceptCode"',
        order: 13,
      },
      monthOfBirth: {
      ...
      calMonth: {
        ...
        referenceFilter: "@REF.\"ConceptVocabularyID\"='mri.CAT.MONTHS'",
        referenceExpression: '@REF."ConceptCode"',
        order: 27,
        isDefault: true,
      },
