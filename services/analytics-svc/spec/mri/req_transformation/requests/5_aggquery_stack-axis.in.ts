export let input = {
    cards: {
        ...
        {
            content: [{
                _configPath: "patient.conditions.acme.interactions.surgery",
                _instanceNumber: 1,
                _instanceID: "patient.conditions.acme.interactions.surgery.1",
                _name: "Surgery A",
                _attributes: {
                    content: [{
                        _configPath: "patient.conditions.acme.interactions.surgery.attributes.exist",
                        _instanceID: "patient.conditions.acme.interactions.surgery.1.attributes.exist",
                        _constraints: {
                            content: [],
                        },
                    },
                    {
                        _configPath: "patient.conditions.acme.interactions.surgery.attributes.surgery_ops",
                        _instanceID: "patient.conditions.acme.interactions.surgery.1.attributes.surgery_ops",
                        _constraints: {
                            content: [],
                        },
                    }],
