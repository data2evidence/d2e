                    ...
                    content: [
                        {
                            ...
                            attributes: {
                                content: [
                                                    ...
                                                    content: [
                                                        {
                                                            type: "Expression",
                                                            operator: ">=",
                                                            value: "2009-05-01T00:00:00.000Z",
                                                        },
                                                        {
                                                            type: "Expression",
                                                            operator: "<=",
                                                            value: "2009-05-31T23:59:59.999Z",
                                                        },
                                                    ],
                                                    type: "BooleanContainer",
                                                    op: "AND",
                                    ...
                                    {
                                        configPath:
                                            "patient.interactions.drugera.attributes.enddate",
                                        instanceID:
                                            "patient.interactions.drugera.1.attributes.enddate",
                                        type: "Attribute",
                                        constraints: {
                                            content: [
                                                {
                                                    content: [
                                                        {
                                                            type: "Expression",
                                                            operator: "<=",
                                                            value: "2009-11-30T23:59:59.999Z",
                                                        },
                                                    ],
                                                    type: "BooleanContainer",
                                                    op: "AND",
