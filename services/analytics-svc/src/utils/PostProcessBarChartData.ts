 ...
 *
 */
export function fillMissingValues(result: MRIEndpointResultType, boxplot = false) {
  ...
  const newResult = { ...cloneJson(result), data } as MRIEndpointResultType
...
export function _getFullValueRange(data: any[], category: MRIEndpointResultCategoryType, NOVALUE: string) {
  const valueSet = {}
 ...
 *
 */
export function formatBinningLabels(result: MRIEndpointResultType) {
...
export function makeBinLabel(
  ...
  category: undefined | MRIEndpointResultCategoryType,
  NOVALUE: string
) {
...
export function postProcessBarChartData(preProcessedData: MRIEndpointResultType) {
 ...
 */
function formatData(result: MRIEndpointResultType, NOVALUE: string) {
  result.data.forEach(datapoint =>
