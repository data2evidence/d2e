...
SELECT 
  cast(cast(CASE WHEN ard1.analysis_id = 107 THEN ard1.stratum_1 ELSE null END AS INT) * 10 AS VARCHAR(11)) || '-' || cast((cast(CASE WHEN ard1.analysis_id = 107 THEN ard1.stratum_1 ELSE null END AS INT) + 1) * 10 - 1 AS VARCHAR(11)) 
                                                             AS category,
