...
export async function seed(knex: Knex): Promise<void> {
  ...
  await knex
    ...
    .insert([
      ...
      {
        Id: "l20t83a0-ade9-4a33-90ae-cf760813943c",
        Version: "1",
        Status: "A",
        Name: "I2B2_DM_DUCKDB",
        Type: "HC/HPH/CDW",
      ...
      {
        Id: "5fl3cb7-32bf-4b46-8cba-32e4f77a14dd",
        Version: "A",
        Status: "",
        Name: "I2B2_PA_CONF_DUCKDB",
        Type: "HC/MRI/PA",
        Data: paI2b2ConfigDuckdb,
        ParentId: "l20t83a0-ade9-4a33-90ae-cf760813943c",
        ParentVersion: "1",
        Creator: "ALICE",
        Created: "2024-06-11 15:30:54",
        Modifier: "ALICE",
  ...
  patient: {
    ...
    attributes: {
      ...
      Gender: {
        ...
        referenceFilter: '(@REF.name_char) SIMILAR TO \'@SEARCH_QUERY\'',
        referenceExpression: '@REF.name_char',
        order: 4,
        useRefValue: true,
      },
