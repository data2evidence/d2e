...
const rawUp = `CREATE TABLE IF NOT EXISTS ${process.env.PG_SCHEMA}."ConfigDbModels_Config" (
...
const rawDown = `DROP TABLE IF EXISTS ${process.env.PG_SCHEMA}."ConfigDbModels_Config"`
