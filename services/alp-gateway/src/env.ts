...
export const env = {
  ...
  ALP_UI_URL: process.env.ALP__UI_URL,
  APPROUTER_BASE_URL: process.env.APPROUTER__BASE_URL!,
  NIFI_MGMT_SVC_BASE_URL: process.env.NIFI_MGMT_SVC__BASE_URL!,
  DATAFLOW_MGMT_API_BASE_URL: process.env.DATAFLOW_MGMT__API_BASE_URL!,
  TERMINOLOGY_SVC_BASE_URL: process.env.TERMINOLOGY_SVC__BASE_URL!,
  ...
  SQLEDITOR__BASE_URL: process.env.SQLEDITOR__BASE_URL!,
