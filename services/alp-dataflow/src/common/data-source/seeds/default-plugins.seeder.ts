    ...
    const entities = repository.create([
      {
        ...
        type: 'default',
        url: 'https://alp-os/d2e-plugins.git@main#subdirectory=cohort-generator',
      ...
      },
      {
        ...
        type: 'default',
        url: 'https://alp-os/d2e-plugins.git@main#subdirectory=data-characterization',
        status: PluginUploadStatus.PENDING,
        createdBy: 'system',
        modifiedBy: 'system'
      },
      {
        ...
        type: 'default',
        url: 'https://alp-os/d2e-plugins.git@main#subdirectory=data-management',
        status: PluginUploadStatus.PENDING,
        createdBy: 'system',
        modifiedBy: 'system'
      },
      {
        ...
        name: 'data-quality',
        type: 'default',
        url: 'https://alp-os/d2e-plugins.git@main#subdirectory=data-quality',
        status: PluginUploadStatus.PENDING,
        createdBy: 'system',
        modifiedBy: 'system'
      },
      {
        ...
        name: 'dataflow-ui',
        type: 'default',
        url: 'https://alp-os/d2e-plugins.git@main#subdirectory=dataflow-ui',
        status: PluginUploadStatus.PENDING,
        createdBy: 'system',
        modifiedBy: 'system'
      },
      {
        ...
        name: 'cachedb',
        type: 'default',
        url: 'https://alp-os/d2e-plugins.git@main#subdirectory=cachedb',
        status: PluginUploadStatus.PENDING,
        createdBy: 'system',
        modifiedBy: 'system'
      },
      {
        ...
        name: 'i2b2',
        type: 'default',
        url: 'https://alp-os/d2e-plugins.git@main#subdirectory=i2b2',
        status: PluginUploadStatus.PENDING,
        createdBy: 'system',
        modifiedBy: 'system'
      },
      {
        ...
        type: 'default',
        url: 'https://alp-os/d2e-plugins.git@main#subdirectory=meilisearch-embeddings',
        status: PluginUploadStatus.PENDING,
        createdBy: 'system',
        modifiedBy: 'system'
      },
      {
        ...
        name: 'meilisearch',
        type: 'default',
        url: 'https://alp-os/d2e-plugins.git@main#subdirectory=meilisearch',
        status: PluginUploadStatus.PENDING,
        createdBy: 'system',
        modifiedBy: 'system'
      },
      {
        ...
        name: 'r-cdm',
        type: 'default',
        url: 'https://alp-os/d2e-plugins.git@main#subdirectory=r-cdm',
        status: PluginUploadStatus.PENDING,
        createdBy: 'system',
        modifiedBy: 'system'
      },
      {
        ...
        name: 'data-load',
        type: 'default',
        url: 'https://alp-os/d2e-plugins.git@main#subdirectory=data-load',
        status: PluginUploadStatus.PENDING,
        createdBy: 'system',
        modifiedBy: 'system'
      }
