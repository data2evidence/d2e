...
const rawUp = `CREATE TABLE IF NOT EXISTS ${process.env.PG_SCHEMA}."ConfigDbModels_AssignmentHeader" (
...
const rawDown = `DROP TABLE IF EXISTS ${process.env.PG_SCHEMA }."ConfigDbModels_AssignmentHeader";`
