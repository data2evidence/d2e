...
SELECT
  ...
  cast(CAST(CASE WHEN num_analysis_id = 804 THEN num_stratum_4 ELSE null END AS INT) * 10 AS VARCHAR(11)) || '-' || cast((CAST(CASE WHEN num_analysis_id = 804 THEN num_stratum_4 ELSE null END AS INT) + 1) * 10 - 1 AS
