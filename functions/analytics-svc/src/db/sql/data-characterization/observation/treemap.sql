...
SELECT 
  ...
  IFNULL(concept_hierarchy.level3_concept_name,'NA') || '||' || IFNULL(concept_hierarchy.level2_concept_name,'NA') || '||' || IFNULL(concept_hierarchy.level1_concept_name,'NA') || '||' || IFNULL(concept_hierarchy.concept_name,'NA')       AS concept_path,
