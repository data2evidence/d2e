                ...
                content: [
                    {
                        ...
                        _instanceNumber: 2,
                        _instanceID:
                            "patient.conditions.acme.interactions.chemo.2",
                            ...
                            content: [
                                {
                                    _configPath:
                                        "patient.conditions.acme.interactions.chemo.attributes.chemo_ops",
                                    _instanceID:
                                        "patient.conditions.acme.interactions.chemo.2.attributes.chemo_ops",
                                    _constraints: {
                                        content: [],
                                    },
                                },
                ...
                content: [
                    {
                        ...
                        _instanceNumber: 3,
                        _instanceID:
                            "patient.conditions.acme.interactions.chemo.3",
                            ...
                            content: [
                                {
                                    _configPath:
                                        "patient.conditions.acme.interactions.chemo.attributes.chemo_ops",
                                    _instanceID:
                                        "patient.conditions.acme.interactions.chemo.3.attributes.chemo_ops",
                                    _constraints: {
                                        content: [],
                                    },
                                },
                                ...
                                },
                                {
                                    ...
                                    _instanceID:
                                        "patient.conditions.acme.interactions.chemo.3.attributes.calYear",
                                    _constraints: {
                                        content: [],
                                    },
                                },
