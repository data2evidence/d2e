sap.ui.define([], function () {
    ...
    var MessageStrip = sap.ui.layout.VerticalLayout.extend("legacy.config.global.ui.lib.MessageStrip", {
    ...
    MessageStrip.prototype.setText = function (newText) {
        ...
        var translatedText = this.getModel("i18n")._oResourceBundle.getText(newText);
