...
export class UpdateDashboard1705398488032 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "portal"."dataset_dashboard" DROP CONSTRAINT "FK_77f2bcaf046c4a2bf1822765874"`
    );
    await queryRunner.query(
      `ALTER TABLE "portal"."dataset_dashboard" DROP CONSTRAINT "REL_77f2bcaf046c4a2bf182276587"`
    );
    await queryRunner.query(
