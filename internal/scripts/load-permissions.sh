...
[ -f .env.$ENV_TYPE ] && source .env.$ENV_TYPE || echo "FATAL .env.$ENV_TYPE not found" && exit 0
...
POSTGRES_TENANT_READ_PASSWORD=POSTGRES_TENANT_READ_PASSWORD_PLAIN
POSTGRES_TENANT_ADMIN_PASSWORD=POSTGRES_TENANT_ADMIN_PASSWORD_PLAIN
