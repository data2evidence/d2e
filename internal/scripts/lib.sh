...
# mimic javascript core publicEncrypt & privateDecrypt with openssl
source ${DOTENV_FILE_OUT:-.env.${ENV_TYPE:-local}}
...
# echo HANA__TENANT_ADMIN_PASSWORD_PLAIN=$(private-decrypt $HANA__TENANT_ADMIN_PASSWORD_SALT $HANA__TENANT_ADMIN_PASSWORD)
# echo HANA__TENANT_READ_PASSWORD_PLAIN=$(private-decrypt $HANA__TENANT_READ_PASSWORD_SALT $HANA__TENANT_READ_PASSWORD)
