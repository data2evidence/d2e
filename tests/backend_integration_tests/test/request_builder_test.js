    ...
    describe('RequestBuilder', function () {
                    ...
                    'content': [
                        {
                            'content': [{
                            ...
                            },
                                {
                                    ...
                                    '_attributes': {
                                        'content': [{
                                            '_configPath': 'patient.conditions.condition_a.interactions.cond_a_interaction_1.1.attributes.char_attr',
                                            '_instanceID': 'patient.conditions.condition_a.interactions.cond_a_interaction_1.1.attributes.char_attr',
                                            '_constraints': {
                                                'content': []
                                            }
                                        }]
                                ...
                                },
                                {
                                    ...
                                    '_attributes': {
                                        'content': [{
                                            '_configPath': 'patient.conditions.condition_a.interactions.cond_a_interaction_2.1.attributes._absTime',
                                            '_instanceID': 'patient.conditions.condition_a.interactions.cond_a_interaction_2.1.attributes._absTime',
                                            '_constraints': {
                                                'content': [{
                                                    'content': [{
                                                        '_operator': '>=',
                                ...
                                },
                                {
                                    'content': [{
                                        ...
                                        '_attributes': {
                                            'content': [{
                                                '_configPath': 'patient.conditions.condition_a.interactions.cond_a_interaction_2.2.attributes.char_attr',
                                                '_instanceID': 'patient.conditions.condition_a.interactions.cond_a_interaction_2.2.attributes.char_attr',
                                                '_constraints': {
                                                    'content': [{
                                                        '_operator': '=',
                                                        '_value': 'B'
                        ...
                        },
                        {
                            'content': [{
                                ...
                                '_attributes': {
                                    'content': [{
                                        '_configPath': 'patient.conditions.condition_a.interactions.cond_a_interaction_2.3.attributes.num_attr',
                                        '_instanceID': 'patient.conditions.condition_a.interactions.cond_a_interaction_2.3.attributes.num_attr',
                                        '_constraints': {
                                            'content': [{
                                                '_operator': '=',
                                                '_value': 10
                                ...
                                },
                                {
                                    ...
                                    '_attributes': {
                                        'content': [{
                                            '_configPath': 'patient.conditions.condition_b.interactions.cond_b_interaction_1.1.attributes.char_attr',
                                            '_instanceID': 'patient.conditions.condition_b.interactions.cond_b_interaction_1.1.attributes.char_attr',
                                            '_constraints': {
                                                'content': [{
                                                    '_operator': '=',
                                                    '_value': 'C'
        ...
        describe('request()', function () {
            ...
            it('resets the filtercard counters - IFR', function () {
                ...
                expect(jsonResult.cards.content[0].content[0]._instanceID).to.equal('patient.interactions.patient_interaction_1.1');
            });
        ...
        describe('filtercard()', function () {
            ...
            it('does not accept "basicdata as a valid tag', function () {
                ...
                var failFunc = function () {
                    requestBuilder.request()
                        .filtercard('patient_interaction_1', 'basicdata');
                };
                ...
                describe('called after request()', function () {
                    ...
                    it('adds a new filtercard (no. 1) of the specified type when called for the first time - IFR', function () {
                        ...
                        requestBuilder.request()
                            .filtercard('cond_a_interaction_1');
                        var jsonResult = requestBuilder.buildIFR();
                        expect(jsonResult.cards.content[0].content[0]._instanceID).to.equal('patient.conditions.condition_a.interactions.cond_a_interaction_1.1');
                    });
            ...
            describe('called after attribute() at the basic data level', function () {
                ...
                it('concatenates constraints if called multiple times for the same attributes', function () {
                    ...
                    requestBuilder.request()
                        .basicdata()
                        .attribute('char_attr', filterObj1)
                        .attribute('char_attr', filterObj2);
                    var jsonResult = requestBuilder.buildJson();
            ...
            describe('called after filtercard() with a patient interaction (i.e. interaction is in list passed to RequestBuilder constructor)', function () {
                ...
                it('sets the attribute constraint to an array containing the specified value (if first constraint)', function () {
                    ...
                    requestBuilder.request()
                        ...
                        .attribute('num_attr', filterObj);
                    var jsonResult = requestBuilder.buildJson();
                    expect(jsonResult[0].patient.interactions.patient_interaction_1['1'].attributes.num_attr[0]).to.eql({ filter: [filterObj] });
                });
                ...
                it('concatenates constraints if called multiple times for the same attributes', function () {
                    ...
                    requestBuilder.request()
                        ...
                        .attribute('num_attr', filterObj2);
                    var jsonResult = requestBuilder.buildJson();
                    expect(jsonResult[0].patient.interactions.patient_interaction_1['1'].attributes.num_attr[0]).to.eql({ filter: [filterObj1, filterObj2] });
                });
            ...
            describe('called after filtercard() with a condition interaction', function () {
                ...
                it('uses the default condition name is no other name is given', function () {
                    ...
                    requestBuilder.request()
                        ...
                        .attribute('num_attr', {});
                    var jsonResult = requestBuilder.buildJson();
                    expect(jsonResult[0].patient.conditions.condition_a.interactions.cond_a_interaction_1['1'].attributes.num_attr[0]).to.exist;
                });
                ...
                it('uses the default condition name is no other name is given - IFR', function () {
                    ...
                    var attr = fc[0]._attributes.content.filter(function (e) {
                        return e._instanceID === 'patient.conditions.condition_a.interactions.cond_a_interaction_1.1.attributes.num_attr';
                    });
                ...
                it('adds an array with an empty object if no constraint is given and the path does not exist', function () {
                    ...
                    requestBuilder.request()
                        ...
                        .attribute('char_attr');
                    var jsonResult = requestBuilder.buildJson();
                    expect(jsonResult[0].patient.conditions.condition_a.interactions.cond_a_interaction_1['1'].attributes.char_attr[0]).to.eql({});
                });
                ...
                it('adds an array with an empty object if no constraint is given and the path does not exist - IFR', function () {
                    ...
                    var attr = fc[0]._attributes.content.filter(function (e) {
                        return e._instanceID === 'patient.conditions.condition_a.interactions.cond_a_interaction_1.1.attributes.char_attr';
                    });
                    expect(attr.length).to.equal(1);
                    expect(attr[0]._constraints.content.length).to.equal(0);
                });
                ...
                it('sets the attribute constraint to an array containing the specified value (if first constraint)', function () {
                    ...
                    requestBuilder.request()
                        ...
                        .attribute('num_attr', filterObj);
                    var jsonResult = requestBuilder.buildJson();
                    expect(jsonResult[0].patient.conditions.condition_a.interactions.cond_a_interaction_1['1'].attributes.num_attr[0]).to.eql({ filter: [filterObj] });
                });
                ...
                it('concatenates constraints if called multiple times for the same attributes', function () {
                    ...
                    requestBuilder.request()
                        ...
                        .attribute('num_attr', filterObj2);
                    var jsonResult = requestBuilder.buildJson();
                    expect(jsonResult[0].patient.conditions.condition_a.interactions.cond_a_interaction_1['1'].attributes.num_attr[0]).to.eql({ filter: [filterObj1, filterObj2] });
                });
            ...
            describe('called after attribute() at the (condition interaction) filtercard level', function () {
                ...
                it('adds an array with an empty object if no constraint is given and the path does not exist', function () {
                    ...
                    requestBuilder.request()
                        ...
                        .attribute('num_attr');
                    var jsonResult = requestBuilder.buildJson();
                    expect(jsonResult[0].patient.conditions.condition_a.interactions.cond_a_interaction_1['1'].attributes.num_attr[0]).to.eql({});
                });
        ...
        describe('exclude()', function () {
            ...
            it('sets the preceding condition interaction filtercard to be excluded - IFR', function () {
                ...
                var jsonResult = requestBuilder.buildIFR();
                var fc = jsonResult.cards.content[0].content.filter(function (e) {
                    return e.content && e.content[0]._instanceID === 'patient.conditions.condition_a.interactions.cond_a_interaction_1.1';
                });
                expect(fc.length).to.equal(1);
            });
        });
        ...
        describe('absolutetime()', function () {
            ...
            describe('called after filtercard() with a patient interaction', function () {
                ...
                it('inserts the passed constraint as the absolute time constraints on the preceding interaction, if called for the first time', function () {
                    ...
                    requestBuilder.request()
                        ...
                        .absolutetime({ a: 1 });
                    var jsonResult = requestBuilder.buildJson();
                    expect(jsonResult[0].patient.interactions.patient_interaction_1['1'].attributes._absTime[0].filter).to.eql([{ a: 1 }]);
                });
                ...
                it('adds the passed constraint to the absolute time constraints on the preceding interaction, if it was called before', function () {
                    ...
                    requestBuilder.request()
                        ...
                        .absolutetime({ b: 2 });
                    var jsonResult = requestBuilder.buildJson();
                    expect(jsonResult[0].patient.interactions.patient_interaction_1['1'].attributes._absTime[0].filter).to.eql([{ a: 1 }, { b: 2 }]);
                });
            ...
            describe('called after filtercard() with a condition interaction', function () {
                ...
                it('adds an absolute time constraint on the preceding interaction', function () {
                    ...
                    var jsonResult = requestBuilder.buildJson();
                    expect(jsonResult[0].patient.conditions.condition_a.interactions.cond_a_interaction_1['1'].attributes._absTime).to.exist;
                });
                ...
                it('adds an absolute time constraint on the preceding interaction - IFR', function () {
                    ...
                    var attr = fc[0]._attributes.content.filter(function (e) {
                        return e._instanceID === 'patient.conditions.condition_a.interactions.cond_a_interaction_1.1.attributes._absTime';
                    });
                ...
                it('inserts the passed constraint as the absolute time constraints on the preceding interaction, if called for the first time', function () {
                    ...
                    requestBuilder.request()
                        ...
                        .absolutetime({ a: 1 });
                    var jsonResult = requestBuilder.buildJson();
                    expect(jsonResult[0].patient.conditions.condition_a.interactions.cond_a_interaction_1['1'].attributes._absTime[0].filter).to.eql([{ a: 1 }]);
                });
                ...
                it('adds the passed constraint to the absolute time constraints on the preceding interaction, if it was called before', function () {
                    ...
                    requestBuilder.request()
                        ...
                        .absolutetime({ b: 2 });
                    var jsonResult = requestBuilder.buildJson();
                    expect(jsonResult[0].patient.conditions.condition_a.interactions.cond_a_interaction_1['1'].attributes._absTime[0].filter).to.eql([{ a: 1 }, { b: 2 }]);
                });
            ...
            describe('with a "isSucceededBy" constraint', function () {
                ...
                it('sets the succeeding interaction to be the one referred to by the first tag', function () {
                    ...
                    requestBuilder.request()
                        ...
                        .relativetime('isSucceededBy', 'a', 'b', { a: 1 });
                    var jsonResult = requestBuilder.buildJson();
                    expect(jsonResult[0].patient.interactions.patient_interaction_1['1'].attributes._succ[0].value).to.equal('patient.interactions.patient_interaction_1.2');
                });
                ...
                it('sets the succeeding interaction constraint to be the passed one', function () {
                    ...
                    requestBuilder.request()
                        ...
                        .relativetime('isSucceededBy', 'a', 'b', { a: 1 });
                    var jsonResult = requestBuilder.buildJson();
                    expect(jsonResult[0].patient.interactions.patient_interaction_1['1'].attributes._succ[0].filter).to.eql([{ a: 1 }]);
                });
        ...
        describe('Chart settings', function () {
            ...
            describe('xaxis()', function () {
                ...
                it('assigns the attribute specified by the filtercard tag and the attribute name to the x-axis', function () {
                    ...
                    var jsonResult = requestBuilder.buildJson();
                    expect(jsonResult[0].patient.conditions.condition_a.interactions.cond_a_interaction_1['1'].attributes.char_attr[0].xaxis).to.equal(2);
                });
                ...
                it('assigns the attribute specified by the filtercard tag and the attribute name to the x-axis - IFR', function () {
                    ...
                    var jsonResult = requestBuilder.buildIFR();
                    expect(jsonResult.axes.length).to.equal(1);
                    expect(jsonResult.axes[0].id).to.equal('patient.conditions.condition_a.interactions.cond_a_interaction_1.1.attributes.char_attr');
                    expect(jsonResult.axes[0].axis).to.equal('x');
                    expect(jsonResult.axes[0].seq).to.equal(2);
                });
                ...
                it('sets the axis no. to 1 if null is passed as axis number', function () {
                    ...
                    requestBuilder.request()
                        ...
                        .attribute('char_attr', {})
                        .chart()
                        .xaxis('basicdata', 'char_attr', null);
                    var jsonResult = requestBuilder.buildJson();
                    expect(jsonResult[0].patient.attributes.char_attr[0].xaxis).to.equal(1);
                });
