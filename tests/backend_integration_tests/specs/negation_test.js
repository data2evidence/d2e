...
describe('-- BASIC SPECS FOR MRI EXCLUDED CARD LOGIC --', function () {
    ...
    before(function (done) {
        ...
        patientBuilder.patient() // No interactions
                            .attribute('lastName', 'No1')
                        .add();
        patientBuilder.patient() // A
