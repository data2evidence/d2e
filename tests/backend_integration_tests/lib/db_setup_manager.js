...
DbSetupManager.prototype.createOrg = function (org, cb) {
    ...
    function createOrg(callback) {
        that.testEnvironment.insertIntoTable('legacy.cdw.db.models::Config.Org', {
            OrgID: org,
            ValidFrom: '1950-01-02T00:00:00.000Z'
        }, callback);
    }
    function createOrgAncestor(callback) {
        that.testEnvironment.insertIntoTable('legacy.cdw.db.models::Config.OrgAncestors', {
            OrgID: org,
            AncestorOrgID: org,
            Distance: 0
        }, callback);
...
DbSetupManager.prototype.assignUserToOrg = function (user, org, cb) {
    this.testEnvironment.insertIntoTable('legacy.cdw.db.models::Config.UserOrgMapping', {
        OrgID: org,
        UserName: user
    }, cb);
};
...
DbSetupManager.prototype.teardownDb = function (callback) {
    ...
    // Do the actual work here
    async.series([
        revokeAccessRightsTask,
        tearDownTestEnvTask
    ], stopHdbClientCallback);
};
